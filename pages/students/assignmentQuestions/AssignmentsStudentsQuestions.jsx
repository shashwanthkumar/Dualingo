...
import SingleNormalQuestion from "../normalQuestions/SingleNormalQuestion";
import SingleAudio from "../normalQuestions/SingleAudio";
import SingleFill from "../normalQuestions/SingleFill";
...
import SingleSpeakText from "../normalQuestions/SingleSpeakText";
import { useSpeechSynthesis } from "react-speech-kit";

const AssignmentsStudentsQuestions = () => {
  ...
  const handleRemarks = async () => {
    const data = await updateStudentsById(user.id, {
      ...student,
      assignmentsQTotal: answers,
    });
    // localStorage.setItem("total", data.data);
    const d = new Date();
    const assignments = {
      date: d,
      assignments: answers.length,
      status: "Completed",
    };
        ...
        <Box sx={{ display: "flex", alignItems: "center" }}>
          <Box sx={{ width: "100%", mr: 1 }}>
            <LinearProgress
              ...
              value={increase * (100 / data.length)}
              color={"success"}
...
export default AssignmentsStudentsQuestions;
